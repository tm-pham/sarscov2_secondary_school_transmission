...
school.epidemic <- function(seed = 12345,
                            ...
                            compliance_quaran = 1,
                            isolation_flag = T,
                            quarantine_flag = T,          # Quarantine of close contacts
                            quarantine_class_flag = T,    # Quarantine of class mates
                            ...
                            prop_vacc_1_dose = 0.35, 
                            prop_vacc_2_dose = 0.15,
                            vacc_eff_1 = c(0.2, 0.59),
                            vacc_eff_2 = c(0.78, 0.9),
                            vacc_eff_teacher_1 = c(0.2, 0.59),
                            vacc_eff_teacher_2 = c(0.78, 0.9),
                            vacc_rate_weekly_1 = 0.01, 
                            vacc_rate_weekly_2 = 0.01, 
                            vacc_weekly_flag = 0, 
                            t_2nd_dose = 21, 
                            vacc_eff_lag = c(14,14),
                            prop_student_boost = 0, 
                            prop_teacher_boost = 0,
                            VE_booster_increase = 1.5, 
